# Funciones auxiliares para descomponer la esperanza de vida con el método
# integral lineal de Horiuchi.
...
cause_names <- c(
  ...
  "2" = "Neoplasias",
  "3" = "Diabetes",
  "4" = "Homicidios y otras causas violentas",
  "5" = "Otras causas externas",
  "6" = "Afecciones del periodo perinatal",
...
# Esperanza de vida al nacer a partir de tasas de mortalidad por edad
...
# Desviación estándar de la distribución de las edades a la muerte
...
# Desviación estándar a partir de tasas por edad y causa
